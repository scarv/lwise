...
export ROCKET_GNU_REPO="${REPO_HOME}/build/hw-toolchain/riscv-gnu-toolchain"
export ROCKET_GNU_COMMIT="b468107e701433e1caca3dbc8aef8d40e0c967ed"
export ROCKET_GNU_PATCH="${REPO_HOME}/src/hw-toolchain/riscv-gnu.patch"
export ROCKET_GNU_BUILD="${ROCKET_GNU_REPO}/build"

export ROCKET_FESVR_REPO="${REPO_HOME}/build/hw-toolchain/riscv-fesvr"

...
.macro ALZETTE_DEC xi, yi, ci, t0, t1
  ...
  xor                  \xi, \xi, \ci // \xi = \xi ^ \ci        => xi = xi ^ ci
  B_RORI               \t0, \xi, 31  // \t0 = ROR32( \xi, 31 ) =>             xi >>> 31

...
- Our strategy for each candidate is roughly
  ...
  | [Elephant](https://csrc.nist.gov/CSRC/media/Projects/lightweight-cryptography/documents/finalist-round/updated-spec-doc/elephant-spec-final.pdf)           | `elephant` | [o](./doc/elephant/design.md) | [o](./doc/elephant/encoding.txt) | o         |          |          |

...
- Our strategy for each candidate is roughly
  ...
  | [Romulus](https://csrc.nist.gov/CSRC/media/Projects/lightweight-cryptography/documents/finalist-round/updated-spec-doc/romulus-spec-final.pdf)             | `romulus`  | [o](./doc/romulus/design.md) | [o](./doc/romulus/encoding.txt) | o         |          |          |
